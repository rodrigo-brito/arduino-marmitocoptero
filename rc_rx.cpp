...
#define max_high_time 2000 // [uS] Maximum expected high time
#define min_high_time 1000 // [uS] Minimum expected high time
...
void read_rc_rx(){
  noInterrupts();
//  CH1 = floor(CH1_delta/ARRED)*ARRED;
  CH2 = floor(CH2_delta/ARRED)*ARRED;
  CH3 = floor(CH3_delta/ARRED)*ARRED;
  CH4 = floor(CH4_delta/ARRED)*ARRED;
  interrupts();
}
